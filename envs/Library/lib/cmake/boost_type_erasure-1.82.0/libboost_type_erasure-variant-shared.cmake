...
if(__boost_imploc)
  message(SEND_ERROR "Target Boost::type_erasure already has an imported location '${__boost_imploc}', which is being overwritten with '${_BOOST_LIBDIR}/boost_type_erasure.lib'")
endif()
...
set_target_properties(Boost::type_erasure PROPERTIES
  ...
  IMPORTED_IMPLIB_RELEASE "${_BOOST_LIBDIR}/boost_type_erasure.lib"
  )

set_target_properties(Boost::type_erasure PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_BOOST_LIBDIR}/boost_type_erasure.dll"
  )
