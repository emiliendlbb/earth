...
if(__boost_imploc)
  message(SEND_ERROR "Target Boost::math_tr1l already has an imported location '${__boost_imploc}', which is being overwritten with '${_BOOST_LIBDIR}/boost_math_tr1l.lib'")
endif()
...
set_target_properties(Boost::math_tr1l PROPERTIES
  ...
  IMPORTED_IMPLIB_RELEASE "${_BOOST_LIBDIR}/boost_math_tr1l.lib"
  )

set_target_properties(Boost::math_tr1l PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_BOOST_LIBDIR}/boost_math_tr1l.dll"
  )
